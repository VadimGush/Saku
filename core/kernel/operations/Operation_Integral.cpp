...
Operation_Integral::Operation_Integral(function_type& function, double a, double b) : function_{function}, range_{a, b} {}

std::shared_ptr<Calc::Object> Operation_Integral::Calculate(RuntimePlatform&) {
